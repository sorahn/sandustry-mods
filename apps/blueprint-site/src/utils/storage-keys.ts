export const REMEMBER_BLUEPRINT_KEY = "sandustry.blueprintInspector.remember";
export const SAVED_BLUEPRINT_KEY = "sandustry.blueprintInspector.string";
...
export const SHOW_SPRITES_KEY = "sandustry.blueprintInspector.showSprites";
